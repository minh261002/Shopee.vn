  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-[#ee4d2d] to-[#ff7337] h-[400px] w-full relative flex flex-col items-center justify-center text-white">
            ...
            <div className="relative w-32 h-32 mb-8">
              ...
              >
                <div className="w-full h-full rounded-full border-4 border-t-white/80 border-r-white/40 border-b-white/20 border-l-white/60" />
              </motion.div>
              ...
              <svg className="absolute inset-0 w-full h-full -rotate-90">
                <motion.circle
                  ...
                  animate={{ strokeDashoffset: 377 - (377 * loadingProgress) / 100 }}
                  transition={{ duration: 0.5 }}
                />
              </svg>
            </div>
            ...
            >
              <h2 className="text-2xl font-bold mb-2">Đang cấu hình cửa hàng</h2>
              <p className="text-white/80 mb-4">Vui lòng đợi trong giây lát...</p>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              />
              <motion.div
                className="absolute -left-20 -bottom-20 w-80 h-80 rounded-full bg-white/10"
                animate={{
                  scale: [1.2, 1, 1.2],
                  opacity: [0.2, 0.1, 0.2],
                }}
